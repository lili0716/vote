<template>
    <div class="login-container">
        <n-card class="login-card" :bordered="false">
            ...
            <n-form ref="formRef" :model="formData" :rules="rules" label-placement="left" label-width="80" size="large">
                <n-form-item label="工号" path="username">
                    <n-input v-model:value="formData.username" placeholder="请输入工号" :maxlength="50" clearable
